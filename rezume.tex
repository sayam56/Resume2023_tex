...
\resumeHeadingListStart{}
  ...
  {Enosis Solutions}{Dhaka, Bangladesh}
    \resumeItemListStart{}
      ...
      \resumeItem{Led and mentored a \textbf{team of 5 automation QA members} by reviewing requirements, test plans, automation scripts and maintaining the CI pipeline.}
...
\resumeHeadingListStart{}
  \resumeQuadHeading{Co-Founder \& CEO}{Mar 2021 -- Present}
  {NerdEvolution}{Dhaka, Bangladesh}
    \resumeItemListStart{}
      \resumeItem{Engaged in meetings with potential clients to elicit and assess specific requirements.}
      \resumeItem{Leveraged cutting-edge technologies to architect software solutions tailored to specific needs and requirements of the project.}
      \resumeItem{Managed and coordinated a cross-functional team of developers, designers, and project managers to ensure seamless product development and timely delivery.}
      \resumeItem{Ensured seamless integration of the Scrum framework for efficient management of day-to-day tasks.}
    \resumeItemListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
